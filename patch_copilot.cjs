...
// I can't easily import formatApiError unless I move it, but I can inline a smaller version or just do basic JSON parsing.
// Actually `copilot-engine.ts` is imported by `server.ts`. 
