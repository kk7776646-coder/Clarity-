...
const funcEnd = '/* ============================================================'; // We know the next section is Utility Helpers

const startIndex = js.indexOf(funcStart);
const endIndex = js.indexOf(funcEnd, startIndex);

if (startIndex > -1 && endIndex > -1) {
    const oldCode = js.substring(startIndex, endIndex);
...
\n`;
    ...
    console.log("Success replacing renderRunTestTab function exactly!");
} else {
