...
// I am just going to replace the whole function by parsing braces.
const startStr = "function renderRunTestTab(container, projectId, analysis) {";
...
if (startIndex > -1) {
    ...
    if (endIndex > -1) {
        const slice = js.substring(startIndex, endIndex + 1);
  ...
  startPolling();
        ...
        console.log("AST-style brace parsed successfully and function replaced!");
    } else {
