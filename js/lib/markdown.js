...
(function () {
  ...
  function renderCode(block) {
    ...
    var langDisplay = lang ? '<span class="code-lang">' + escapeHtml(lang) + '</span>' : '';
    return '<pre class="code-block"><div class="code-block__header">' + langDisplay + copyBtn + '</div><code' + langClass + '>' + highlighted + '</code></pre>';
  }
