...
window.NexaRAG.auth = {
  ...
  renderGate() {
    ...
    main.innerHTML = [
      ...
      '        <img class="auth-gate__img auth-gate__img--light" src="assets/clarity-icon.png" alt="" />',
      '        <img class="auth-gate__img auth-gate__img--dark" src="assets/clarity-icon-white.png" alt="" />',
      '      </span>',
