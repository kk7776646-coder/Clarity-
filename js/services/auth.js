...
window.NexaRAG.auth = {
  ...
  renderGate() {
    ...
    main.innerHTML = [
      ...
      '        <img class="auth-gate__img auth-gate__img--light" src="/assets/clarity-icon-DeMDDmpx.png" alt="" />',
      '        <img class="auth-gate__img auth-gate__img--dark" src="/assets/clarity-icon-white-Bm0itYmq.png" alt="" />',
      '      </span>',
